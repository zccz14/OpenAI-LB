...
const copy = {
  zh: {
    ...
    auditTitle:"逐调用审计",auditDescription:"不记录 prompt、Authorization 或 OAuth 凭据；请求 ID 可用于关联上游故障。",noAudit:"暂无审计事件",noAuditDescription:"每次代理调用结束后都会写入基础审计记录。",time:"时间",requestId:"请求 ID",channel:"渠道",endpointModel:"接口 / 模型",latency:"延迟",cachedInput:"缓存输入",
